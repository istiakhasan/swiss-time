      ...
      <main className="my-10">
        ...
        <section className="mb-11">
          <div className="flex items-center justify-center md:flex-row lg:flex-row flex-col">
            <img
              className="mr-10 w-[40%] lg:h-[500px] object-cover"
              src={product.image}
              alt=""
            />
            <div className="lg:w-[40%] px-6 lg:px-0 mt-6 lg:mt-0">
              ...
              <div>
                <button
                  onClick={handleReducQuantity}
                  className="bg-[#FB4D19] text-white font-bold text-sm py-2 px-11 rounded shadow-[#7c3520] shadow-md"
                >
                  delivered
                </button>
              </div>
              ...
              <form onSubmit={handleSubmit} className="mt-5">
                ...
                <input
                  ...
                  className="outline-none pl-8 py-2 border-gray-500 border-2 rounded-md"
                  type="number"
                  placeholder="Please enter a number"
                />

                <p className="text-red-900 font-bold ">{inputValue.error}</p>

                <button
                  type="submit"
                  className="px-16 py-2 rounded bg-[#332CF2] shadow-md shadow-green-900 text-white  mt-2 "
                >
                  Add
                </button>
              </form>
          ...
          <button
            ...
            className=" button-29 my-20 mx-auto"
          >
            Manage Inventories
          </button>
        </section>
