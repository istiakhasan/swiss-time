        ...
        <div className="flex-1">
          <div className="w-[70%] mx-auto">
            ...
            <p className="mt-3 text-lg ">
              Watch Movements The movement , or caliber, is the engine whice
              powers a watch and its functions.This internal mechanism of the
              timepiece moves the hands and powers all features of the watch
              such as the chronograph, annual calendar, moon phase...
            </p>
          </div>
        </div>
