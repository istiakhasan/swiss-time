  ...
  <>
    <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
      <div className="relative flex items-center justify-between h-16">
          ...
          <div className="hidden  md:block sm:ml-6">
            <div className="flex space-x-4">
              ...
              <>
                ...
                <Link to="/manageinventory" className="text-white font-bold hover:bg-white hover:text-[#5572FF] lg:px-3 px-0  py-2 rounded-md text-sm ">
                Manage Items
                </Link>

                <Link to="/myitems" className="text-white font-bold hover:bg-white hover:text-[#5572FF] lg:px-3 px-0  py-2 rounded-md text-sm ">
                My Items
                </Link>
              </>
        ...
        <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
          ...
          <Link className=" bg-white px-6 lg:px-12 text-[#5572FF] font-bold lg:mx-6  py-2 rounded-lg" to="/login">
          Login
          </Link>
          )
          }
    ...
    <Disclosure.Panel className="lg:hidden ">
      <div className="px-2 pt-2 pb-3 space-y-1 flex flex-col items-center">
        ...
        user && (
        <>
          <Disclosure.Button as={Link} to="/addinventory"
            className="hover:bg-white px-6 lg:px-12 text-white hover:text-[#5572FF] font-bold lg:mx-6  py-2 rounded-lg">
            Add Items
          </Disclosure.Button>
          <Disclosure.Button as={Link} to="/manageinventory"
            className="hover:bg-white px-6 lg:px-12 text-white hover:text-[#5572FF] font-bold lg:mx-6  py-2 rounded-lg">
            Manage Items
          </Disclosure.Button>
          <Disclosure.Button as={Link} to="/myitems"
            className="hover:bg-white px-6 lg:px-12 text-white hover:text-[#5572FF] font-bold lg:mx-6  py-2 rounded-lg">
            My Items
          </Disclosure.Button>
        </>
        ...
        <Disclosure.Button as={Link} to="/blogs"
          className="hover:bg-white px-6 lg:px-12 text-white hover:text-[#5572FF] font-bold lg:mx-6  py-2 rounded-lg">
          Blogs
        </Disclosure.Button>
        <Disclosure.Button as={Link} to="/contactus"
          className="hover:bg-white px-6 lg:px-12 text-white hover:text-[#5572FF] font-bold lg:mx-6  py-2 rounded-lg">
          Contact Us
        </Disclosure.Button>
